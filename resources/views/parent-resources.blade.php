...
@section('content')
    ...
    <div class="brand-bg-gradient-yo d-flex align-items-center justify-content-center" style="position: relative; height: 100%;">
        <div>
            <h2 class="text-center py-5">Resources for Parents</h2>
    ...
    <div>
        <div class="py-5">
            ...
            @if($code == 'inclusion' || $code == 'equity')
                @include('_connected-parents')
            @else
                <div style="height: 100%;" class="d-flex align-items-center justify-content-center text-center">
                    <form method="post" action="parent-resources" style="border: 1px solid silver; border-radius: 10px;" class="p-5">
